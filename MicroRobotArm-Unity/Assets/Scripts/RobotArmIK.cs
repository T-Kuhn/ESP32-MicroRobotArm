...
namespace RobotArm
{
    ...
    public class RobotArmIK : MonoBehaviour
    {
        ...
        public float Link1 { get { return _link1; } }
        public float Link2 { get { return _link2; } }
        public float Link3 { get { return _link3; } }
        public float Link4 { get { return _link4; } }
        ...
        void Update()
        {
            var targetAngles = RunIK(
                _target.position.x,
                _target.position.y,
                _rotationTarget.rotation.eulerAngles.z * Mathf.Deg2Rad,
                elbowUp);
